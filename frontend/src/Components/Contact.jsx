  ...
  return (
    <div>
      <div className="container mx-auto my-9 md:w-5xl w-full relative py-20 text-white h-[80vh] ">
        <div className="title text-center absolute top-5 left-15 md:left-90 md:[&>*:nth-child(2)]:text-3xl [&>*:nth-child(2)]:text-xl m-auto">
          <p>A Simple title prefix</p>
          <p>SEND ME A MESSAGE</p>
        </div>

        <div className="left text-black md:mx-14 absolute bottom-0 left-1 text-center md:absolute md:top-41 text-sm md:text-xl">
        ...
        <div className="right flex justify-end md:mx-10">
          <form onSubmit={handleClick} className='flex flex-col gap-2 min-w-60 md:mx-8 my-6 mx-auto' action="">
